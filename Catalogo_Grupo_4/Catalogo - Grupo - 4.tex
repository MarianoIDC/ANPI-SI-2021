...
\begin{document}
	...
	\subsubsection{Regla del Trapecio y Cota de Error}
	
	\lstinputlisting[style=Matlab-editor, basicstyle=\mlttfamily\normalsize, caption={Lenguaje M.}]{CodigosOctave/ReglaTrapecio.m}

	\subsubsection{Regla de Simpson y Cota de Error}
	...
	\subsubsection{Regla Compuesta del Trapecio y Cota de Error}
	
	\subsubsection{Regla Compuesta de Simpson y Cota de Error}
	
	\subsubsection{Cuadratura Gaussiana y Cota de Error}
