...
\begin{document}
	...
	\lstinputlisting[language=Python, basicstyle=\ttfamily\normalsize, keywordstyle=\color{violet}\ttfamily, frame=single, commentstyle=\color{gray}\ttfamily, showstringspaces=false, caption={Lenguaje Python.}]{CodigosPython/PredictorCorrector.py}
