...
f = np.array([
    ...
    '39.6*0.155*x2 + ((39.6*(0.155**2)*(x2**2))/(1-0.155*x2)) - (39.6*0.155*x3) - ((39.6*(0.155**2)*(x2**2))/(1-0.155*x3)) + (6.0*x4) + ((6.0*(x4**2))/(1-x4)) - (6.0*x3) - ((6.0*(x3**2))/(1-x3))',
    '39.6*0.155*x3 + ((39.6*(0.155**2)*(x3**2))/(1-0.155*x3)) - (39.6*0.155*x4) - ((39.6*(0.155**2)*(x2**2))/(1-0.155*x4)) + (6.0*x5) + ((6.0*(x5**2))/(1-x5)) - (6.0*x4) - ((6.0*(x4**2))/(1-x4))',
    '39.6*0.155*x4 + ((39.6*(0.155**2)*(x4**2))/(1-0.155*x4)) - (39.6*0.155*x5) - ((39.6*(0.155**2)*(x2**2))/(1-0.155*x5)) + (6.0*0.77) + ((6.0*(0.77**2))/(1-0.77)) - (6.0*x5) - ((6.0*(x5**2))/(1-x5))'], 
    dtype = object)
tol = 0.00001
iterMax = 10
